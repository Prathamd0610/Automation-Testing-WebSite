...
export const MODULES: ModuleMeta[] = [
  ...
  // ---- More Form Controls ----
  {
    id: 'rating',
    title: 'Star Rating',
    description: 'Hover-preview star rating with click-to-commit and keyboard support.',
    path: '/modules/rating',
    category: 'Form Controls',
    icon: Star,
  ...
  },
  {
    id: 'color-picker',
    title: 'Colour Picker',
    description: 'Native colour input, hex field and preset swatches kept in sync.',
    path: '/modules/color-picker',
    category: 'Form Controls',
    icon: Palette,
  ...
  },
  {
    ...
    description: 'Auto-advancing one-time-password boxes with paste and backspace.',
    path: '/modules/otp-input',
    category: 'Form Controls',
    icon: KeyRound,
    tags: ['otp', 'code', 'verification', '2fa'],
    difficulty: 'intermediate',
  },
  ...
  // ---- More Interactions ----
  {
    id: 'context-menu',
    title: 'Context Menu',
    description: 'Right-click to open a custom menu that closes on Escape or outside click.',
    path: '/modules/context-menu',
    category: 'Interactions',
    icon: Menu,
    tags: ['context', 'right-click', 'menu'],
    difficulty: 'intermediate',
  },
  {
    id: 'sortable-list',
    title: 'Reorderable List',
    description: 'Move items up and down and assert on the resulting order.',
    path: '/modules/sortable-list',
    category: 'Interactions',
    icon: ArrowUpDown,
    tags: ['sort', 'reorder', 'list'],
    difficulty: 'intermediate',
  },
  ...
  // ---- More Components ----
  {
    id: 'carousel',
    title: 'Carousel',
    description: 'Slide gallery with arrows, dots and a pausable autoplay timer.',
    path: '/modules/carousel',
    category: 'Components',
    icon: Images,
  ...
  },
  {
    id: 'tree-view',
    title: 'Tree View',
    description: 'Expandable file tree where deep nodes appear only once expanded.',
    path: '/modules/tree-view',
    category: 'Components',
    icon: ListTree,
    tags: ['tree', 'explorer', 'expand'],
    difficulty: 'advanced',
  },
  {
    id: 'stepper',
    title: 'Quantity Stepper',
    description: 'Increment/decrement control with min/max bounds and a live total.',
    path: '/modules/stepper',
    category: 'Components',
    icon: Calculator,
    tags: ['stepper', 'quantity', 'number'],
    difficulty: 'beginner',
  },
  {
    id: 'notifications',
    title: 'Notifications Center',
    description: 'Mark notifications read individually or all at once, with an unread badge.',
    path: '/modules/notifications',
    category: 'Components',
    icon: Inbox,
    tags: ['notifications', 'badge', 'inbox'],
    difficulty: 'intermediate',
  },
  {
    id: 'rich-text',
    title: 'Rich Text Editor',
    description: 'A contenteditable editor with a bold/italic/list formatting toolbar.',
    path: '/modules/rich-text',
    category: 'Components',
    icon: Type,
    tags: ['editor', 'contenteditable', 'wysiwyg'],
    difficulty: 'advanced',
  },
  ...
  // ---- More Data & Network ----
  {
    id: 'download',
    title: 'File Download',
    description: 'Generate and download CSV, JSON and text files from the browser.',
    path: '/modules/download',
    category: 'Data & Network',
    icon: Download,
    tags: ['download', 'csv', 'json', 'blob'],
    difficulty: 'intermediate',
  },
  {
    id: 'lazy-images',
    title: 'Lazy-Loaded Images',
    description: 'A gallery whose tiles load asynchronously and flip to a loaded state.',
    path: '/modules/lazy-images',
    category: 'Data & Network',
    icon: ImageIcon,
    tags: ['lazy', 'images', 'loading'],
    difficulty: 'intermediate',
  },
